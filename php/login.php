...
if ($_SERVER['REQUEST_METHOD'] !== 'POST' && !empty($_SESSION['logado'])) {
    ...
    if ($tipoSessao === 'pessoa') {
        ...
        header('Location: ' . AuthController::redirectByUserType($tipoSessao));
    }
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if ($auth['usuario']['tipo'] === 'pessoa') {
            ...
            $_SESSION['nome_pessoa'] = $auth['usuario']['nome'];
            $_SESSION['email_pessoa'] = $auth['usuario']['email'];

            header('Location: ' . ($possuiCurriculo ? 'pessoa.php' : 'cadastrar_curriculo.php'));
            exit;
        }
...
<header class="cabecalho-site">
    ...
    <nav class="navegacao">
        <ul>
            <li><a href="index.php">Conheça o DevIN</a></li>
            <li><a href="index.php#etapas">Etapas</a></li>
            <li><a href="index.php#contatos">Contato</a></li>
        </ul>
    </nav>

    <div class="acoes">
        <a class="botao botao-branco" href="cadastro_pessoa.php">
            Cadastrar-se
        </a>
    </div>
</header>
...
<main class="conteudo-login">
    ...
    <div class="area-login">
        ...
        <?php if (!empty($sucesso)): ?>
            <p class="mensagem-sucesso" style="color: green; font-weight: bold; margin-bottom: 10px;">
        ...
        <form action="login.php" method="POST">
            ...
            <a href="recuperacao.php" class="link-esqueceu">
                Esqueceu a Senha?
            </a>
