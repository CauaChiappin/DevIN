                    ...
                    <div class="form-column">
                        ...
                        <div class="input-group password-wrapper">
                            ...
                            <div class="input-icon-container">
                                ...
                                <img src="imagens/olho.png" class="toggle-password-eye" onclick="togglePasswordVisibility('confirme_senha', this)" alt="Ocultar/Mostrar Senha">
                            </div>
                    ...
                    <div class="form-column">
                        ...
                        <div class="input-group password-wrapper">
                            ...
                            <div class="input-icon-container">
                                ...
                                <img src="imagens/olho.png" class="toggle-password-eye" onclick="togglePasswordVisibility('senha', this)" alt="Ocultar/Mostrar Senha">
                            </div>
                        </div>
    ...
    <script>
        ...
        function togglePasswordVisibility(inputId, imgElement) {
            ...
            if (input.type === 'password') {
                input.type = 'text';
                imgElement.src = 'imagens/olho.png'; // Imagem para o estado VISÍVEL
            } else {
                input.type = 'password';
                imgElement.src = 'imagens/olho_senha.png';       // Imagem para o estado OCULTO
            }
        }
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO Empresa (nome, cnpj, cep, email, senha, telefone) VALUES (?, ?, ?, ?, ?, ?)";
